...
2. Install [KronaTools](https://github.com/marbl/Krona). Quick install below. Detail install instruction on [Krona Wiki](https://github.com/marbl/Krona/wiki/KronaTools). 
```
